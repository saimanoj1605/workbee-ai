        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          ...
          >
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              Passionate UI/UX designer with 3+ years of experience creating
              beautiful, user-centered digital experiences. I specialize in
              modern web design, prototyping, and bringing ideas to life through
              code. My approach combines aesthetic excellence with functional
              design principles.
            </p>
